...
export const meta: MetaFunction = () => {
  return [
    { title: "Landing Page" },
    { name: "description", content: "Welcome to GroupieAI!" },
  ];
};
    ...
    <div className="bg-gray-100 min-h-screen">
      {
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <h1 className="mt-10 text-center text-4xl/9 underline tracking-tight text-black">Welcome to GroupieAI! </h1>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-10 text-center text-sm/6 text-gray-500">
              Don't have a GroupieAi account... 
              <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-500"><br></br>Sign up!</a>
            </p>
          </div>
        </div>
      }
